...
title: "11. Directives"
section: "11"
source: "https://docs.nvidia.com/cuda/parallel-thread-execution/#directives"
---

# [11. Directives](https://docs.nvidia.com/cuda/parallel-thread-execution#directives)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#directives "Permalink to this headline")

## [11.1. PTX Module Directives](https://docs.nvidia.com/cuda/parallel-thread-execution#ptx-module-directives)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#ptx-module-directives "Permalink to this headline")
...
The _major_ number is incremented when there are incompatible changes to the PTX language, such as
...
generated. In general, generations of SM architectures follow an _onion layer_ model, where each
...
## [11.2. Specifying Kernel Entry Points and Functions](https://docs.nvidia.com/cuda/parallel-thread-execution#specifying-kernel-entry-points-and-functions)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#specifying-kernel-entry-points-and-functions "Permalink to this headline")
...
of general purpose registers and control registers. See description of [Performance-Tuning Directives: .abi_preserve](https://docs.nvidia.com/cuda/parallel-thread-execution/#performance-tuning-directives-abi-preserve)
and [Performance-Tuning Directives: .abi_preserve_control](https://docs.nvidia.com/cuda/parallel-thread-execution/#performance-tuning-directives-abi-preserve-control) for more details.
...
## [11.3. Control Flow Directives](https://docs.nvidia.com/cuda/parallel-thread-execution#control-flow-directives)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#control-flow-directives "Permalink to this headline")
...
Note that this directive guarantees that the _total_ number of threads does not exceed the maximum,
...
### [11.5.1. Debugging Directives: @@dwarf](https://docs.nvidia.com/cuda/parallel-thread-execution#debugging-directives-atatdwarf)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#debugging-directives-atatdwarf "Permalink to this headline")
...
## [11.6. Linking Directives](https://docs.nvidia.com/cuda/parallel-thread-execution#linking-directives)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#linking-directives "Permalink to this headline")
...
Declares identifier to be globally visible but _weak_. Weak symbols are similar to globally visible
...
## [11.8. Miscellaneous Directives](https://docs.nvidia.com/cuda/parallel-thread-execution#miscellaneous-directives)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#miscellaneous-directives "Permalink to this headline")
