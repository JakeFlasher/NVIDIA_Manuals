...
section: "1"
source: "https://docs.nvidia.com/cuda/parallel-thread-execution/#introduction"
---

# [1. Introduction](https://docs.nvidia.com/cuda/parallel-thread-execution#introduction)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#introduction "Permalink to this headline")

This document describes PTX, a low-level _parallel thread execution_ virtual machine and instruction
set architecture (ISA). PTX exposes the GPU as a data-parallel computing _device_.
...
_PTX_ defines a virtual machine and ISA for general purpose parallel thread execution. PTX programs
...
_PTX_ provides a stable programming model and instruction set for general purpose parallel
...
## [1.3. PTX ISA Version 9.2](https://docs.nvidia.com/cuda/parallel-thread-execution#ptx-isa-version-9-2)[](https://docs.nvidia.com/cuda/parallel-thread-execution/#ptx-isa-version-9-2 "Permalink to this headline")
...
calling convention, and PTX support for abstracting the _Application Binary Interface (ABI)_.
