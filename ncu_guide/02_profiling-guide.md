---
title: "2. Profiling Guide"
section: "2"
source: "https://docs.nvidia.com/nsight-compute/ProfilingGuide/#profiling-guide"
---

# [2. Profiling Guide](https://docs.nvidia.com/nsight-compute/ProfilingGuide#profiling-guide)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#profiling-guide "Permalink to this headline")

Nsight Compute profiling guide.

Profiling Guide with metric types and meaning, data collection modes and FAQ for common problems.

## [2.1. Introduction](https://docs.nvidia.com/nsight-compute/ProfilingGuide#introduction)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#introduction "Permalink to this headline")
...
### [2.1.1. Profiling Applications](https://docs.nvidia.com/nsight-compute/ProfilingGuide#profiling-applications)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#profiling-applications "Permalink to this headline")
...
![../_images/regular-application-process.png](images/profiling-guide_1.png)
...
![../_images/profiled-process.png](images/profiling-guide_2.png)

Profiled Application Execution

## [2.2. Metric Collection](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metric-collection)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metric-collection "Permalink to this headline")

Collection of performance metrics is the key feature of NVIDIA Nsight Compute. Since there is a huge list of metrics available, it is often easier to use some of the tool’s pre-defined [sets or sections](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#sets-and-sections) to collect a commonly used subset. Users are free to adjust which metrics are collected for which kernels as needed, but it is important to keep in mind the [Overhead](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#overhead) associated with data collection.

### [2.2.1. Sets and Sections](https://docs.nvidia.com/nsight-compute/ProfilingGuide#sets-and-sections)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#sets-and-sections "Permalink to this headline")

NVIDIA Nsight Compute uses _Section Sets_ (short _sets_) to decide, on a very high level, the number of metrics to be collected.
Each set includes one or more _Sections_, with each section specifying several logically associated metrics.
...
See [Overhead](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#overhead) for more information on profiling overhead.
...
When adding section directories [recursively](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile), even if the file is present, sub-directories are still searched.

### [2.2.2. Sections and Rules](https://docs.nvidia.com/nsight-compute/ProfilingGuide#sections-and-rules)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#sections-and-rules "Permalink to this headline")
...
### [2.2.3. Replay](https://docs.nvidia.com/nsight-compute/ProfilingGuide#replay)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#replay "Permalink to this headline")
...
#### [Kernel Replay](https://docs.nvidia.com/nsight-compute/ProfilingGuide#kernel-replay)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#kernel-replay "Permalink to this headline")
...
![../_images/replay-regular-execution.png](images/profiling-guide_3.png)

Regular Application Execution

![../_images/replay-kernel.png](images/profiling-guide_4.png)

Execution with Kernel Replay. All memory is saved, and memory written by the kernel is restored in-between replay passes.

#### [Application Replay](https://docs.nvidia.com/nsight-compute/ProfilingGuide#application-replay)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#application-replay "Permalink to this headline")
...
![../_images/replay-regular-execution.png](images/profiling-guide_5.png)

Regular Application Execution

![../_images/replay-application.png](images/profiling-guide_6.png)
...
![../_images/replay-application-kernel-matching.png](images/profiling-guide_7.png)

Kernel matching during application replay using the _grid_ strategy.

#### [Range Replay](https://docs.nvidia.com/nsight-compute/ProfilingGuide#range-replay)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#range-replay "Permalink to this headline")
...
![../_images/replay-range.png](images/profiling-guide_8.png)
...
##### [Defining Ranges](https://docs.nvidia.com/nsight-compute/ProfilingGuide#defining-ranges)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#defining-ranges "Permalink to this headline")
...
##### [Supported APIs](https://docs.nvidia.com/nsight-compute/ProfilingGuide#supported-apis)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#supported-apis "Permalink to this headline")
...
#### [Application Range Replay](https://docs.nvidia.com/nsight-compute/ProfilingGuide#application-range-replay)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#application-range-replay "Permalink to this headline")
...
![../_images/replay-application-range.png](images/profiling-guide_9.png)
...
#### [Limitations](https://docs.nvidia.com/nsight-compute/ProfilingGuide#limitations)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#limitations "Permalink to this headline")
...
#### [Graph Profiling](https://docs.nvidia.com/nsight-compute/ProfilingGuide#graph-profiling)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#graph-profiling "Permalink to this headline")

In multiple replay modes, NVIDIA Nsight Compute can profile CUDA graphs as single workload entities, rather than profile individual kernel nodes. The behavior can be toggled in the respective [command line](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile) or [UI](https://docs.nvidia.com/nsight-compute/NsightCompute/index.html#connection-activity-interactive) options.
...
### [2.2.4. Compatibility](https://docs.nvidia.com/nsight-compute/ProfilingGuide#compatibility)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#compatibility "Permalink to this headline")

The set of available [replay modes](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#replay) and [metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-guide) depends on the type of GPU workload to profile.

| Workload Type | Replay Mode | Metric Groups |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | Kernel | Application | Range | Application-Range | Hardware Counters / SMSP | Unit-Level Source | Instruction-Level Source [^3] | Launch | Warp/PM Sampling |
| Kernel | Yes | Yes | Yes [^2] | Yes [^2] | Yes | Yes | Yes | Yes | Yes |
| Range | No | No | Yes | Yes | Yes | No | Yes | Some | Yes |
| Cmdlist | Yes | No | No | No | Yes | Yes | Yes | Some | Yes |
| Graph [^1] | Yes | No | No | No | Yes | No | No | Some | Yes |
...
**2([1](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id2),[2](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id3))**
...
### [2.2.5. Profile Series](https://docs.nvidia.com/nsight-compute/ProfilingGuide#profile-series)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#profile-series "Permalink to this headline")
...
![../_images/profile-series-action.png](images/profiling-guide_10.png)

Profile Series action.

![../_images/profile-series-dialog.png](images/profiling-guide_11.png)

Profile Series dialog.

### [2.2.6. Overhead](https://docs.nvidia.com/nsight-compute/ProfilingGuide#overhead)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#overhead "Permalink to this headline")
...
The overhead between these mechanisms varies greatly, with launch and device attributes being “statically” available and requiring no kernel runtime overhead.
The overhead incurred by hardware metrics is very low.

Software-patched metrics incur the highest overhead, as they require the kernel to be modified and all patched instructions to execute additional code.
The exact overhead depends on the number and type of software-patched metrics being collected.
It is important though that software-patched metrics are collected in separate replay passes and therefore don’t interfere with the correctness or precision of other metrics.
Their values are also independent of any overhead they may cause.
...
Since each [set](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#sets-and-sections) specifies a group of sections to be collected, choosing a less comprehensive set can reduce profiling overhead. See the `--set` command in the [NVIDIA Nsight Compute CLI](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile) documentation.
- **Number of collected sections**

Since each [section](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#sets-and-sections) specifies a number of metrics to be collected, selecting fewer sections can reduce profiling overhead. See the `--section` command in the [NVIDIA Nsight Compute CLI](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile) documentation.
- **Number of profiled kernels**

By default, all selected metrics are collected for all launched kernels. To reduce the impact on the application, you can try to limit performance data collection to as few kernel functions and instances as makes sense for your analysis. See the filtering commands in the [NVIDIA Nsight Compute CLI](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile) documentation.
...
## [2.3. Metrics Guide](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics-guide)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics-guide "Permalink to this headline")

### [2.3.1. Hardware Model](https://docs.nvidia.com/nsight-compute/ProfilingGuide#hardware-model)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#hardware-model "Permalink to this headline")

#### [Compute Model](https://docs.nvidia.com/nsight-compute/ProfilingGuide#compute-model)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#compute-model "Permalink to this headline")
...
#### [Streaming Multiprocessor](https://docs.nvidia.com/nsight-compute/ProfilingGuide#streaming-multiprocessor)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#streaming-multiprocessor "Permalink to this headline")
...
#### [Compute Preemption](https://docs.nvidia.com/nsight-compute/ProfilingGuide#compute-preemption)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#compute-preemption "Permalink to this headline")

[Compute preemption](https://docs.nvidia.com/cuda/pascal-tuning-guide/index.html#compute-preemption) avoids long running kernels from monopolizing the GPU, at the risk of context switch overhead. The execution context (registers, shared memory, etc.) is saved at preemption and restored later. Context switches happen at instruction-level granularity.
The [exclusive-process](https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#compute-modes) compute mode may be used on supported systems to avoid context switching.

#### [Memory](https://docs.nvidia.com/nsight-compute/ProfilingGuide#memory)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#memory "Permalink to this headline")
...
_Local memory_ is thread-private memory: each CUDA thread has its own dedicated portion of local memory.
Local memory accesses only occur for automatic variables (i.e., variables declared within a function)
that were specified without any of the *__device__*, *__shared__* or *__constant__* memory space specifiers,
if they do not fit into registers or the compiler decides to place them in local memory for other reasons.
...
The local memory space resides in device memory, so local memory accesses have similar performance characteristics as accesses to global memory.
Local memory addresses are translated to global virtual addresses by the AGU unit.

One difference between global and local memory is that local memory is arranged such that consecutive 32-bit words are
accessed by consecutive thread IDs. Accesses are therefore fully coalesced as long as all threads in a warp access the
same relative address (e.g., same index in an array variable, same member in a structure variable, etc.).

To minimize adverse performance impact of local memory accesses consider the following best practices:

- **Prefer Registers:** For small, thread-private variables that are accessed frequently, aim for them to reside in registers.
The compiler often does this automatically for scalar variables.
- **Utilize Shared Memory:** For data that is shared and reused by threads within a block,
shared memory is significantly faster than local memory.
Explicitly manage data in shared memory to maximize its benefits.
- **Increasing the available register count:** Use a higher limit in
[__maxnreg__](https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#maximum-number-of-registers-per-thread)
or a lower thread count in
[__launch_bounds__](https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#launch-bounds)
to increase the number of registers available to each thread. This can help reduce register spilling.
- **Increasing the L1 cache size:** If local memory usage is unavoidable, try to cache most local memory accesses
in L1 by increasing its size with
[cudaFuncSetCacheConfig](https://docs.nvidia.com/cuda/cuda-runtime-api/group__CUDART__EXECUTION.html#group__CUDART__EXECUTION_1g6699ca1943ac2655effa0d571b2f4f15).
- **Using non-caching global memory loads:** If there are many cache misses in the L1 cache,
consider using non-caching global memory loads to reduce contentions by compiling with the nvcc option *-Xptxas –def-load-cache=cg*
(see the [nvcc docs](https://docs.nvidia.com/cuda/cuda-compiler-driver-nvcc/index.html#def-load-cache-dlcm)).

More information on local memory can be found in the
[CUDA C Programming Guide](https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#device-memory-accesses)
and the [CUDA Best Practices Guide](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/index.html#local-memory).
...
#### [Caches](https://docs.nvidia.com/nsight-compute/ProfilingGuide#caches)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#caches "Permalink to this headline")
...
![../_images/hw-model-lts.png](images/profiling-guide_12.png)
...
![../_images/hw-model-l1tex.png](images/profiling-guide_13.png)

Model of Load/Store and Texture pipelines for the L1TEX cache.

#### [Texture/Surface](https://docs.nvidia.com/nsight-compute/ProfilingGuide#texture-surface)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#texture-surface "Permalink to this headline")
...
Information on texture and surface memory can be found in the [Memory Workload Analysis](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#sections-and-rules) section.

### [2.3.2. Metrics Structure](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics-structure)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics-structure "Permalink to this headline")

#### [Metrics Overview](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics-overview)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics-overview "Permalink to this headline")
...
#### [Metrics Entities](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics-entities)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics-entities "Permalink to this headline")
...
In addition to PerfWorks metrics, NVIDIA Nsight Compute uses several other measurement providers that each generate their own metrics. These are explained in the [Metrics Reference](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-reference).

#### [Metrics Examples](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics-examples)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics-examples "Permalink to this headline")
...
#### [Metrics Naming Conventions](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics-naming-conventions)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics-naming-conventions "Permalink to this headline")
...
- submetric: refer to section [Metrics Entities](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-entities)
...
- unit-level, e.g. [here](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#l2-cache-eviction-metrics) or [here](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#sass-unit-level-instructions-executed-metrics)
- instruction-level, e.g. [here](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#instructions-per-opcode-metrics)

There are more instruction-level SASS metrics which don’t have `sass_` in the name, e.g. [here](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#source-metrics).
`device__attribute_sass_level` is not a SASS metric.

#### [Cycle Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#cycle-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#cycle-metrics "Permalink to this headline")
...
#### [Instanced Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#instanced-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#instanced-metrics "Permalink to this headline")
...
You can find which metrics have instance values in the [Metrics Reference](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-reference). In the UI, the [Metric Details](https://docs.nvidia.com/nsight-compute/NsightCompute/index.html#tool-window-metric-details) tool window can be used to conveniently view correlation IDs and instance values for each metric. Also, both the UI and the command line interface provide options to show instance values in addition to a metric aggregate where applicable.

### [2.3.3. Metrics Decoder](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics-decoder)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics-decoder "Permalink to this headline")

The following explains terms found in NVIDIA Nsight Compute metric names, as introduced in [Metrics Structure](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-structure).

### [2.3.4. Units](https://docs.nvidia.com/nsight-compute/ProfilingGuide#units)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#units "Permalink to this headline")

> | `ctc` | Dedicated, high-bandwidth, memory coherent NVLink Chip-2-Chip (C2C) interconnect that can access Extended GPU Memory (EGM).   See <https://developer.nvidia.com/blog/nvidia-grace-hopper-superchip-architecture-in-depth/> for more information. |
> | --- | --- |
...
### [2.3.5. Subunits](https://docs.nvidia.com/nsight-compute/ProfilingGuide#subunits)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#subunits "Permalink to this headline")
...
### [2.3.6. Pipelines](https://docs.nvidia.com/nsight-compute/ProfilingGuide#pipelines)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#pipelines "Permalink to this headline")
...
### [2.3.7. Quantities](https://docs.nvidia.com/nsight-compute/ProfilingGuide#quantities)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#quantities "Permalink to this headline")
...
### [2.3.8. Range and Precision](https://docs.nvidia.com/nsight-compute/ProfilingGuide#range-and-precision)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#range-and-precision "Permalink to this headline")

#### [Overview](https://docs.nvidia.com/nsight-compute/ProfilingGuide#overview)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#overview "Permalink to this headline")
...
#### [Asynchronous GPU activity](https://docs.nvidia.com/nsight-compute/ProfilingGuide#asynchronous-gpu-activity)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#asynchronous-gpu-activity "Permalink to this headline")
...
#### [Workload Durations](https://docs.nvidia.com/nsight-compute/ProfilingGuide#workload-durations)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#workload-durations "Permalink to this headline")

Nsight Compute measures the duration of workloads (e.g., CUDA kernels) differently than Nsight Systems (via CUPTI).
This can lead to discrepancies in the reported duration for the same workload between the two tools.

The following factors impact the measured duration:

- [Clock control](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#clock-control):
Nsight Compute locks SM clocks [by default](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#profile).
Nsight Systems does not lock clocks.
When comparing results, we recommend to lock clocks with `nvidia-smi` externally before profiling and use `--clock-control none` for ncu.
- [Cache control](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#cache-control):
Nsight Compute flushes all GPU caches [by default](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#profile) between replay passes.
Nsight Systems collects data only in a single pass, and therefore also does not flush any caches.
If the workload is highly sensitive to cache state, it’s recommended to use `--replay-mode application --cache-control none` for ncu to let the application handle priming the caches implicitly.
- [Serialization](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#serialization):
Nsight Compute serializes kernel launches, unless a dedicated replay mode is used.
Nsight Systems does not serialize launches.
Concurrent kernels on the same device can lead to differences in the reported duration between the two tools.
- [Tool overhead](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#overhead):
Nsight Compute introduces varying overhead around and during the execution of a workload for the purpose of metric collection:
  ...
  - It is important though to note that this makes it impossible to derive the workload duration using host-side timers or CUDA events when profiling with Nsight Compute,
as such methods would include the overhead introduced by the tool.
- **Duration measurement**:
Nsight Compute and Nsight Systems/CUPTI use different methods to measure the duration of a workload (`gpu__time_duration` metric in Nsight Compute):
  - For the start timestamp, Nsight Compute inserts a _WaitForIdle_ and a semaphore timestamp after the launch setup (copy parameters, copy qmd) and before the submission of the command to execute the grid.
These semaphores are processed by the GPU’s front-end and the timestamp is taken when the semaphore command is executed.
This timestamp consequently occurs before the grid’s blocks and warps are scheduled and distributed to the SMs.

Before Blackwell, Nsight Systems measures the start timestamp by replacing the entry point of the kernel with a prolog that all warps execute.
Logical thread 0 writes out the timestamp. This method is required to trace concurrent kernels.
From Blackwell onwards, Nsight Systems collects the start timestamp using a HW method. It is taken before the first CTA is launched on the SM.
  - For the end timestamp, Nsight Compute inserts a _WaitForIdle_ followed by another semaphore into the command buffer.

Before Blackwell, Nsight Systems instead uses a semaphore that instructs the scheduler unit to collect the timestamp upon completion of all blocks of the grid.
This can occur before or after the semaphore method used by Nsight Compute.
From Blackwell onwards, Nsight Systems collects the end timestamp using a HW method. It is taken after the final memory barrier is issued.
  ...
  - Note that for _Workload Execution_ rows in the PM Sampling [timeline](https://docs.nvidia.com/nsight-compute/NsightCompute/index.html#timeline), Nsight Compute and Nsight Systems use the same method to measure start and end timestamps.

#### [Tool issue](https://docs.nvidia.com/nsight-compute/ProfilingGuide#tool-issue)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#tool-issue "Permalink to this headline")
...
## [2.4. Metrics Reference](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics-reference)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics-reference "Permalink to this headline")

### [2.4.1. Overview](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id5)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id5 "Permalink to this headline")

Most metrics in NVIDIA Nsight Compute can be queried using the ncu command line interface’s [–query-metrics](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile) option.

The following metrics can be collected explicitly but do not follow the naming scheme explained in [Metrics Structure](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-structure). They should be used as-is instead.
These metrics can be listed using `--query-metrics` as per [–query-metrics-collection](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile) option.

`launch__*` metrics are collected per kernel launch, and do not require an additional replay pass. They are available as part of the kernel launch parameters (such as grid size, block size, …) or are computed using the [CUDA Occupancy Calculator](https://docs.nvidia.com/nsight-compute/NsightCompute/index.html#occupancy-calculator).
...
### [2.4.2. Launch Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#launch-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#launch-metrics "Permalink to this headline")

> | `launch__barrier_count` | Number of barriers in the kernel launch. |
> | --- | --- |
...
### [2.4.3. Occupancy Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#occupancy-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#occupancy-metrics "Permalink to this headline")
...
### [2.4.4. NVLink Topology Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#nvlink-topology-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#nvlink-topology-metrics "Permalink to this headline")

> | `nvlink__bandwidth` | Link bandwidth in bytes/s.   Instance values map from logical NVLink ID (uint64) to value (double). |
> | --- | --- |
...
### [2.4.5. NUMA Topology Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#numa-topology-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#numa-topology-metrics "Permalink to this headline")

> | `numa__cpu_affinity` | CPU affinity for each device.   Instance values map from device ID (uint64) to comma-separated values (string). |
> | --- | --- |
...
### [2.4.6. Device Attributes](https://docs.nvidia.com/nsight-compute/ProfilingGuide#device-attributes)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#device-attributes "Permalink to this headline")
...
### [2.4.7. Warp Stall Reasons](https://docs.nvidia.com/nsight-compute/ProfilingGuide#warp-stall-reasons)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#warp-stall-reasons "Permalink to this headline")
...
> | `smsp__pcsamp_warps_issue_stalled_barrier` | Warp was stalled waiting for sibling warps at a CTA barrier. A high number of warps waiting at a barrier is commonly caused by diverging code paths before a barrier. This causes some warps to wait a long time until other warps reach the synchronization point. Whenever possible, try to divide up the work into blocks of uniform workloads. If the block size is 512 threads or greater, consider splitting it into smaller groups. This can increase eligible warps without affecting occupancy, unless shared memory becomes a new occupancy limiter. Also, try to identify which barrier instruction causes the most stalls, and optimize the code executed before that synchronization point first. |
> | --- | --- |
...
### [2.4.8. Warp Stall Reasons (Not Issued)](https://docs.nvidia.com/nsight-compute/ProfilingGuide#warp-stall-reasons-not-issued)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#warp-stall-reasons-not-issued "Permalink to this headline")
...
> | `smsp__pcsamp_warps_issue_stalled_barrier_not_issued` | Warp was stalled waiting for sibling warps at a CTA barrier. A high number of warps waiting at a barrier is commonly caused by diverging code paths before a barrier. This causes some warps to wait a long time until other warps reach the synchronization point. Whenever possible, try to divide up the work into blocks of uniform workloads. If the block size is 512 threads or greater, consider splitting it into smaller groups. This can increase eligible warps without affecting occupancy, unless shared memory becomes a new occupancy limiter. Also, try to identify which barrier instruction causes the most stalls, and optimize the code executed before that synchronization point first. |
> | --- | --- |
...
### [2.4.9. Source Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#source-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#source-metrics "Permalink to this headline")
...
> | `branch_inst_executed` | Number of unique branch targets assigned to the instruction, including both divergent and uniform branches. |
> | --- | --- |
...
### [2.4.10. L2 Cache Eviction Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#l2-cache-eviction-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#l2-cache-eviction-metrics "Permalink to this headline")

> | `smsp__sass_inst_executed_memdesc_explicit_evict_type` | L2 cache eviction policy types. |
> | --- | --- |
...
### [2.4.11. Instructions Per Opcode Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#instructions-per-opcode-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#instructions-per-opcode-metrics "Permalink to this headline")
...
> | `sass__inst_executed_per_opcode` | Number of warp-level executed instructions, instanced by basic SASS opcode. |
> | --- | --- |
...
### [2.4.12. SASS Unit-Level Instructions Executed Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#sass-unit-level-instructions-executed-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#sass-unit-level-instructions-executed-metrics "Permalink to this headline")

Number of unit-level warp instructions executed.

> | `sass__inst_executed_global_loads` | Number of global memory load instructions executed. |
> | --- | --- |
...
### [2.4.13. Metric Groups](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metric-groups)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metric-groups "Permalink to this headline")
...
### [2.4.14. Profiler Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#profiler-metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#profiler-metrics "Permalink to this headline")

Metrics generated by the tool itself to inform about statistics or problems during profiling.

> | `profiler__perfworks_session_reuse` | Indicates if the PerfWorks session was reused between results. |
> | --- | --- |
...
## [2.5. Sampling](https://docs.nvidia.com/nsight-compute/ProfilingGuide#sampling)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#sampling "Permalink to this headline")

NVIDIA Nsight Compute can collect certain performance data via sampling at fixed intervals.

### [2.5.1. PM Sampling](https://docs.nvidia.com/nsight-compute/ProfilingGuide#pm-sampling)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#pm-sampling "Permalink to this headline")

NVIDIA Nsight Compute supports collecting many metrics by sampling the GPU’s performance monitors (PM) periodically at fixed intervals. The resulting metrics are [instanced](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#instanced-metrics), with each sample being composed of its value and the (GPU) timestamp when it was collected. This allows the tool to visualize the data on a [timeline](https://docs.nvidia.com/nsight-compute/NsightCompute/index.html#profiler-report-details-page) that helps you understand how the behavior of the profiled workload changes during its runtime.
...
- The metric name has the `pmsampling:` [prefix](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile).
...
![../_images/pmsampling-tensor-example.png](images/profiling-guide_14.png)

Example PM sampling timeline for an application using tensor cores.
The timeline shows a typical *tail effect* starting at ~6.5ms where there is not sufficient work anymore to fill all SMs.
It also allows you to see the relationship between compute (SM Tensor Pipe Throughput) and data loading (DRAM Throughput and L2 Hit Rate).
Whenever the L2 cache doesn’t have the needed data anymore readily available, its hit rate decreases, DRAM Throughput increases as the data needs to be loaded from global memory,
and the SM Tensor Pipe Throughput decreases as the SMs are waiting for the data to arrive.

#### [Support](https://docs.nvidia.com/nsight-compute/ProfilingGuide#support)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#support "Permalink to this headline")

| Architecture | Support | Sampling Intervals |
| --- | --- | --- |
| Volta and earlier | Not supported | n/a |
| TU10x-GA100 | Supported | >= 20000 cycles |
| GA10x and later | Supported | >= 1000 ns [^5] |

PM sampling is supported on all platforms except vGPU. See below for further limitations that apply to [context switch trace](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#ctx-switch-trace).
You can [query](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile) the list of metrics available to PM sampling using the `--query-metrics-collection pmsampling` option.
...
#### [Context Switch Trace](https://docs.nvidia.com/nsight-compute/ProfilingGuide#context-switch-trace)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#context-switch-trace "Permalink to this headline")

Since this data collection samples across the entire GPU device, the tool concurrently collects a _context switch trace_. The trace is stored as a separate, instanced [metric](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#profiler-metrics). It tracks when the context of interest was active and can be used to filter the sampling metric to only relevant instances and to better align metrics from multiple passes on the timeline. While it’s generally preferable to have this trace collected, it can be disabled using an [environment variable](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#environment-variables).

Note that context switch trace is not supported on Windows Subsystem for Linux (WSL), Multi-Instance GPU (MIG), Multi-Process Service (MPS) with multiple clients, or on mobile platforms.
Context switch trace in containers is supported with CUDA 12.7 drivers or newer.

#### [Counter Domains](https://docs.nvidia.com/nsight-compute/ProfilingGuide#counter-domains)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#counter-domains "Permalink to this headline")
...
Each counter is associated with a _counter domain_, which describes how and where in the hardware the counter is collected.
...
When [querying](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#command-line-options-profile) the PM sampling metric collection, the required and optional domains for a metric’s counter dependencies are shown.
...
Counter domains can only be selected explicitly in [section files](https://docs.nvidia.com/nsight-compute/CustomizationGuide/index.html#counter-domains), using one or more instances of the `CtrDomains: "<domain>"` field for PM sampling metrics.
...
#### [Known Issues](https://docs.nvidia.com/nsight-compute/ProfilingGuide#known-issues)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#known-issues "Permalink to this headline")

You should be aware of the following potential issues when using PM sampling:

Data collected from different passes may not align perfectly. In the below example, each group of warp stall reasons was collected in a separate pass.
The total number of warps doesn’t change during the workload execution, i.e., at one timestamp, data from all passes should sum up to the same total number of warps.
However, due to small misalignments, the aggregate row shows several peaks that are likely flatter in the real execution.

![../_images/pmsampling-misaligned-passes.png](images/profiling-guide_15.png)
...
### [2.5.2. Warp Sampling](https://docs.nvidia.com/nsight-compute/ProfilingGuide#warp-sampling)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#warp-sampling "Permalink to this headline")
...
See the _Warp Stall Reasons_ tables in the [Metrics Reference](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-reference) for a description of the individual warp scheduler states.

## [2.6. Reproducibility](https://docs.nvidia.com/nsight-compute/ProfilingGuide#reproducibility)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#reproducibility "Permalink to this headline")

In order to provide actionable and deterministic results across application runs, NVIDIA Nsight Compute applies various methods to adjust how metrics are collected. This includes [serializing](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#serialization) kernel launches, [purging GPU caches](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#cache-control) before each kernel replay or [adjusting GPU clocks](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#clock-control).

### [2.6.1. Serialization](https://docs.nvidia.com/nsight-compute/ProfilingGuide#serialization)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#serialization "Permalink to this headline")
...
It is possible to force a single global lock to be used for all processes - disabling concurrent profiling across devices - by setting the environment variable `NV_COMPUTE_PROFILER_DISABLE_CONCURRENT_PROFILING`. Refer to the [Environment Variables](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#environment-variables) entry on possible workarounds.
...
### [2.6.2. Clock Control](https://docs.nvidia.com/nsight-compute/ProfilingGuide#clock-control)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#clock-control "Permalink to this headline")
...
- See the [Special Configurations](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#special-configurations) section for MIG and vGPU clock control.

### [2.6.3. Cache Control](https://docs.nvidia.com/nsight-compute/ProfilingGuide#cache-control)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#cache-control "Permalink to this headline")

As explained in [Kernel Replay](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#kernel-replay), the kernel might need to be replayed multiple times to collect all requested metrics. While NVIDIA Nsight Compute can save and restore the contents of GPU device memory accessed by the kernel for each pass, it cannot do the same for the contents of HW caches, such as e.g. the L1 and L2 cache.
...
### [2.6.4. Persistence Mode](https://docs.nvidia.com/nsight-compute/ProfilingGuide#persistence-mode)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#persistence-mode "Permalink to this headline")
...
## [2.7. Special Configurations](https://docs.nvidia.com/nsight-compute/ProfilingGuide#special-configurations)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#special-configurations "Permalink to this headline")

### [2.7.1. Multi Instance GPU](https://docs.nvidia.com/nsight-compute/ProfilingGuide#multi-instance-gpu)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#multi-instance-gpu "Permalink to this headline")
...
#### [Locking Clocks](https://docs.nvidia.com/nsight-compute/ProfilingGuide#locking-clocks)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#locking-clocks "Permalink to this headline")

NVIDIA Nsight Compute is not able to set the clock frequency on any Compute Instance for profiling. You can continue analyzing kernels without fixed clock frequencies (using `--clock-control none`; see [here](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#clock-control) for more details). If you have sufficient permissions, `nvidia-smi` can be used to configure a fixed frequency for the whole GPU by calling `nvidia-smi --lock-gpu-clocks=tdp,tdp`. This sets the GPU clocks to the base TDP frequency until you reset the clocks by calling `nvidia-smi --reset-gpu-clocks`.

#### [MIG on Baremetal (non-vGPU)](https://docs.nvidia.com/nsight-compute/ProfilingGuide#mig-on-baremetal-non-vgpu)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#mig-on-baremetal-non-vgpu "Permalink to this headline")

All Compute Instances on a GPU share the same clock frequencies.

#### [MIG on NVIDIA vGPU](https://docs.nvidia.com/nsight-compute/ProfilingGuide#mig-on-nvidia-vgpu)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#mig-on-nvidia-vgpu "Permalink to this headline")
...
### [2.7.2. CUDA Green Contexts](https://docs.nvidia.com/nsight-compute/ProfilingGuide#cuda-green-contexts)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#cuda-green-contexts "Permalink to this headline")

[CUDA Green Contexts](https://docs.nvidia.com/cuda/cuda-driver-api/group__CUDA__GREEN__CONTEXTS.html#group__CUDA__GREEN__CONTEXTS) is a feature of the CUDA driver API
that allows spacial partitioning of a GPU by assigning a set of resources to a CUDA context on which the context should operate on.
NVIDIA Nsight Compute supports profiling applications using CUDA Green Contexts by enabling collection of the same metrics as described in the [Metrics Reference](https://docs.nvidia.com/nsight-compute/ProfilingGuide/metrics-reference.html).
In particular, any combination of _Workload Type_ and _Replay Mode_ within the [compatibility matrix](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#compatibility) is also supported for Green Context applications.
For a list of API functions supported in range-based replay modes refer to the _Green Contexts_ section in the [supported APIs](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#supported-apis).

Unlike with regular CUDA contexts, when using Green Contexts, metrics are subdivided into two categories: those that can be attributed to a Green Context directly, and those that cannot.
The former comprise of metrics that are collected on hardware units that are directly assigned to the Green Context, such as SMs or the L1 cache, where the latter
are composed of metrics that do not give exclusive access to a Green Context, such as the L2 cache. The former will be referred to as Green-Context _attributable_ metrics
and the latter as _non-attributable_ metrics.

Since it is generally more insightful to analyze the performance of a Green Context application relative to the resources it was assigned, instead of the entire GPU,
_attributable_ metrics are scaled to the number of SMs of the Green Context. [^7] This is not the case for _non-attributable_ metrics.
Refer to the _supported driver versions_ below for more information on the minimum driver version required for this feature.

To get an overview of how Green Contexts are supported in the UI, including ways to distinguish _attributable_ and _non-attributable_ metrics, refer to the
[Green Contexts support](https://docs.nvidia.com/nsight-compute/NsightCompute/index.html#green-contexts-support) section. On the CLI, *–print-metric-attribution* may be used to display the attribution levels,
see the [Command Line Options](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#console-output).

#### [Supported driver versions](https://docs.nvidia.com/nsight-compute/ProfilingGuide#supported-driver-versions)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#supported-driver-versions "Permalink to this headline")

Starting with NVIDIA Nsight Compute 2024.1, profiling of applications using CUDA Green Contexts is fully supported. This requires a minimum driver version of 550.
Note, however, that with this version metrics were always scaled to the number of all SMs available on the GPU.
...
****
  ...
  Although not intended as the primary use-case, different Green Contexts can be initialized with overlapping resources.
  When executing and profiling such Green Contexts concurrently, _attributable_ metrics may contain contributions from multiple Green Contexts,
  although the same metric scaling behavior as described in this section would still apply.

### [2.7.3. Multi-Process Service](https://docs.nvidia.com/nsight-compute/ProfilingGuide#multi-process-service)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#multi-process-service "Permalink to this headline")

The Multi-Process Service (MPS) runtime architecture enables cooperative multi-process CUDA applications to utilize Hyper-Q capabilities on NVIDIA GPUs.
This allows CUDA kernels to be processed concurrently on the same GPU, benefitting performance when the GPU compute capacity is underutilized by a single application process.
...
#### [Launching MPS Applications](https://docs.nvidia.com/nsight-compute/ProfilingGuide#launching-mps-applications)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#launching-mps-applications "Permalink to this headline")

When profiling MPS applications, Nsight Compute differentiates between *MPS client processes* and the *ncu control process*.
Client (application) processes must be launched using the `ncu --mps client` command. Each client will be suspended, waiting for the control process to attach.
The ncu control process is launched as `ncu --mps control`. It will wait until the expected number of client processes is active, attach to them and start profiling.
The arguments to the control process specify how to select and replay workloads (kernel or range), which metrics to collect, the output report file, etc.
The ncu processes launching the MPS client processes act only as simple launchers. However, if the client processes are expected to trace NVTX (e.g. for defining ranges by NVTX markers), the `--nvtx` flag is needed.
A typical set of launch commands may hence look like this:
...
While Nsight Compute supports profiling MPS applications with `--replay-mode kernel`, it is recommended to use `--replay-mode range` whenever possible.
In the former mode, each MPS client can only contribute a single kernel launch.
...
#### [Observation Window](https://docs.nvidia.com/nsight-compute/ProfilingGuide#observation-window)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#observation-window "Permalink to this headline")

![../_images/mps-observation-window-range.png](images/profiling-guide_16.png)
...
regardless which one is chosen as the primary at runtime.
This applies to both `kernel` and `range` replay modes.
Note that all ranges are start-aligned to allow for deterministic replays.

![../_images/mps-observation-window-kernel.png](images/profiling-guide_17.png)

When a primary client is specified explicitly using `primary-client`, the observation window is the limited to the duration of this client,
as long as it participates in the profile. All concurrent clients are still included for the duration of the window.
This applies to both `kernel` and `range` replay modes.
Note that all ranges are start-aligned to allow for deterministic replays.

#### [Data Collection](https://docs.nvidia.com/nsight-compute/ProfilingGuide#data-collection)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#data-collection "Permalink to this headline")
...
#### [Limitations](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id10)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id10 "Permalink to this headline")
...
- The list of workload filter options during collection is reduced. Only the following are supported:
`kernel-name`, `kernel-name-base`, `launch-count`, `launch-skip`, `nvtx-push-pop-scope`.

## [2.8. Metric Distributor](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metric-distributor)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metric-distributor "Permalink to this headline")

The Metric Distributor distributes the workload of metric collection across multiple NCU processes, reducing the total number of passes required by the profiler. The Metric Distributor is particularly useful when a large number of metrics need to be collected and multiple GPUs are available in the system.
The actual reduction in profiling overhead depends on the total number of metrics, the number of available GPUs, and the types of metrics being collected.
...
- The Metric Distributor parallelizes the metric collection task across multiple GPUs. As a result, each NCU process generates a partial report file (e.g., `report0.ncu-rep`).
These partial reports **must be merged** into a single, complete report using  [Report Merge Tool](https://docs.nvidia.com/nsight-compute/NsightCompute/index.html#report-merge-tool).
- For the distributor to work correctly, all participating GPUs must have an identical chip architecture.
- The Metric Distributor requires the communicator option to be set to either `none` or `tcp`. See [Multi-Process Support](https://docs.nvidia.com/nsight-compute/NsightComputeCli/index.html#multi-process).
...
## [2.9. Roofline Charts](https://docs.nvidia.com/nsight-compute/ProfilingGuide#roofline-charts)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#roofline-charts "Permalink to this headline")
...
> **Note**
>
> The values of operations/second calculated from this NVIDIA developer tools site and generated by using the data center monitoring tools are not calculated in the same way as the operations/second
> used for export control purposes and should not be relied upon to assess performance against the export control limits.

### [2.9.1. Overview](https://docs.nvidia.com/nsight-compute/ProfilingGuide#roofline-overview)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#roofline-overview "Permalink to this headline")
...
![../_images/roofline-overview.png](images/profiling-guide_18.png)
...
### [2.9.2. Analysis](https://docs.nvidia.com/nsight-compute/ProfilingGuide#analysis)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#analysis "Permalink to this headline")

The roofline chart can be very helpful in guiding performance optimization efforts for a particular kernel.

![../_images/roofline-analysis.png](images/profiling-guide_19.png)
...
## [2.10. Memory Chart](https://docs.nvidia.com/nsight-compute/ProfilingGuide#memory-chart)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#memory-chart "Permalink to this headline")
...
### [2.10.1. Overview](https://docs.nvidia.com/nsight-compute/ProfilingGuide#memory-chart-overview)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#memory-chart-overview "Permalink to this headline")

![../_images/memory-chart-a100.png](images/profiling-guide_20.png)

Memory chart for an NVIDIA A100 GPU

#### [Logical Units (green)](https://docs.nvidia.com/nsight-compute/ProfilingGuide#logical-units-green)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#logical-units-green "Permalink to this headline")
...
#### [Physical Units (blue)](https://docs.nvidia.com/nsight-compute/ProfilingGuide#physical-units-blue)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#physical-units-blue "Permalink to this headline")
...
#### [Links](https://docs.nvidia.com/nsight-compute/ProfilingGuide#links)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#links "Permalink to this headline")

Links between _Kernel_ and other logical units represent the number of executed instructions (_Inst_) targeting the respective unit.
For example, the link between _Kernel_ and _Global_ represents the instructions loading from or storing to the global memory space.
...
Links between logical units and blue, physical units represent the number of requests (_Req_) issued as a result of their respective instructions.
For example, the link going from _L1/TEX Cache_ to _Global_ shows the number of requests generated due to global load instructions.

The color of each link represents the percentage of peak utilization of the corresponding communication path.
The color legend to the right of the chart shows the applied color gradient from unused (0%) to operating at peak performance (100%).
If a link is inactive, it is shown in grey color.
...
#### [Ports](https://docs.nvidia.com/nsight-compute/ProfilingGuide#ports)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#ports "Permalink to this headline")

A unit often shares a common data port for incoming and outgoing traffic. While the links sharing a port might operate well below their individual peak performances, the unit’s data port may have already reached its peak.
Port utilization is shown in the chart by colored rectangles inside the units located at the incoming and outgoing links.
Ports use the same color gradient as the data links and have also a corresponding marker to the left of the legend.
Inactive ports are shown in grey color.

#### [Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#metrics)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#metrics "Permalink to this headline")
...
![../_images/memory-peak-mapping.png](images/profiling-guide_21.png)

Mapping of peak values between memory tables and memory chart

## [2.11. Memory Tables](https://docs.nvidia.com/nsight-compute/ProfilingGuide#memory-tables)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#memory-tables "Permalink to this headline")
...
### [2.11.1. Shared Memory](https://docs.nvidia.com/nsight-compute/ProfilingGuide#shared-memory)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#shared-memory "Permalink to this headline")

![../_images/memory-tables-smem.png](images/profiling-guide_22.png)

Example Shared Memory table, collected on an RTX 2080 Ti

#### [Columns](https://docs.nvidia.com/nsight-compute/ProfilingGuide#columns)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#columns "Permalink to this headline")

| `Instructions` | For each access type, the total number of all actually executed assembly (SASS) [instructions](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-quantities) per warp. Predicated-off instructions are not included.   E.g., the instruction _STS_ would be counted towards _Shared Store_. |
| --- | --- |
| `Requests` | The total number of all [requests](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-quantities) to shared memory. On SM 7.0 (Volta) and newer architectures, each shared memory instruction generates exactly one request. |
| `Wavefronts` | Number of [wavefronts](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-quantities) required to service the requested shared memory data. Wavefronts are serialized and processed on different cycles. |
...
#### [Rows](https://docs.nvidia.com/nsight-compute/ProfilingGuide#rows)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#rows "Permalink to this headline")

| `(Access Types)` | Shared memory access operations. |
| --- | --- |
| `Total` | The aggregate for all access types in the same column. |

#### [Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id13)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id13 "Permalink to this headline")
...
### [2.11.2. L1/TEX Cache](https://docs.nvidia.com/nsight-compute/ProfilingGuide#l1-tex-cache)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#l1-tex-cache "Permalink to this headline")

![../_images/memory-tables-l1.png](images/profiling-guide_23.png)

Example L1/TEX Cache memory table, collected on an RTX 2080 Ti

![../_images/hw-model-l1tex-ga100-global.png](images/profiling-guide_24.png)

Model of the Global Load Pipeline for the L1TEX cache on GA100, mapped to the memory table.

#### [Columns](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id14)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id14 "Permalink to this headline")

| `Instructions` | For each access type, the total number of all actually executed assembly (SASS) [instructions](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-quantities) per warp. Predicated-off instructions are not included.   E.g., the instruction _LDG_ would be counted towards _Global Loads_. |
| --- | --- |
| `Requests` | The total number of all [requests](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-quantities) to L1, generated for each instruction type. On SM 7.0 (Volta) and newer architectures, each instruction generates exactly one request for LSU traffic (global, local, …). For texture (TEX) traffic, more than one request may be generated.   In the example, each of the 65536 global load instructions generates exactly one request. |
| `Wavefronts` | Number of [wavefronts](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-quantities) required to service the requested memory operation. Wavefronts are serialized and processed on different cycles. |
| `Wavefront % Peak` | Percentage of peak utilization for the units processing [wavefronts](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-quantities). High numbers can imply that the processing pipelines are saturated and can become a bottleneck. |
| `Sectors` | The total number of all L1 [sectors](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-quantities) accesses sent to L1. Each load or store request accesses one or more sectors in the L1 cache. Atomics and reductions are passed through to the L2 cache. |
...
#### [Rows](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id15)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id15 "Permalink to this headline")
...
#### [Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id16)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id16 "Permalink to this headline")
...
### [2.11.3. L2 Cache](https://docs.nvidia.com/nsight-compute/ProfilingGuide#l2-cache)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#l2-cache "Permalink to this headline")

![../_images/memory-tables-l2.png](images/profiling-guide_25.png)

Example L2 Cache memory table, collected on an RTX 2080 Ti

![../_images/hw-model-lts-ga100.png](images/profiling-guide_26.png)

Model of the L2 cache on GA100, mapped to the memory table.

#### [Columns](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id17)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id17 "Permalink to this headline")
...
| --- | --- |
| `Sectors` | For each access type, the total number of [sectors](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-decoder__metrics-quantities) requested from the L2 cache. Each request accesses between one and four sectors. |
...
#### [Rows](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id18)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id18 "Permalink to this headline")
...
#### [Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id19)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id19 "Permalink to this headline")
...
### [2.11.4. L2 Cache Eviction Policies](https://docs.nvidia.com/nsight-compute/ProfilingGuide#l2-cache-eviction-policies)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#l2-cache-eviction-policies "Permalink to this headline")

![../_images/memory-tables-l2-evict-policy.png](images/profiling-guide_27.png)

Example L2 Cache Eviction Policies memory table, collected on an A100 GPU

#### [Columns](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id20)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id20 "Permalink to this headline")
...
#### [Rows](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id21)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id21 "Permalink to this headline")
...
#### [Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id22)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id22 "Permalink to this headline")
...
### [2.11.5. Device Memory](https://docs.nvidia.com/nsight-compute/ProfilingGuide#device-memory)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#device-memory "Permalink to this headline")

![../_images/memory-tables-dram.png](images/profiling-guide_28.png)

Example Device Memory table, collected on an RTX 2080 Ti

#### [Columns](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id23)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id23 "Permalink to this headline")
...
#### [Rows](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id24)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id24 "Permalink to this headline")

| `(Access Types)` | Device memory loads and stores. |
| --- | --- |
| `Total` | The aggregate for all access types in the same column. |

#### [Metrics](https://docs.nvidia.com/nsight-compute/ProfilingGuide#id25)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#id25 "Permalink to this headline")
...
## [2.12. FAQ](https://docs.nvidia.com/nsight-compute/ProfilingGuide#faq)[](https://docs.nvidia.com/nsight-compute/ProfilingGuide/#faq "Permalink to this headline")

- **n/a metric values**

n/a means that the metric value is “not available”. The most common reason is that the requested metric does not exist. This can either be the result of a typo, or a missing [suffix](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#metrics-structure__metrics-examples). Verify the metric name against the output of of the `--query-metrics`NVIDIA Nsight Compute CLI option.
...
This includes e.g. percentages exceeding 100% or metrics reporting negative values. For further details, see [Range and Precision](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#range-and-precision).
...
This indicates that the GPU, on which the current kernel is launched, is not supported. See the [Release Notes](https://docs.nvidia.com/nsight-compute/ReleaseNotes/index.html#gpu-support) for a list of devices supported by your version of NVIDIA Nsight Compute. It can also indicate that the current _GPU configuration_ is not supported. For example, NVIDIA Nsight Compute might not be able to profile GPUs in SLI configuration.
...
NVIDIA Nsight Compute failed to create or open the file `(path)` with write permissions. This file is used for inter-process [serialization](https://docs.nvidia.com/nsight-compute/ProfilingGuide/index.html#serialization). NVIDIA Nsight Compute does not remove this file after profiling by design. The error occurs if the file was created by a profiling process with permissions that prevent the current process from writing to this file, or if the current user can’t acquire this file for other reasons (e.g., certain Linux kernel security settings).
...
See [System Requirements](https://docs.nvidia.com/nsight-compute/ReleaseNotes/index.html#system-requirements) for Linux.
