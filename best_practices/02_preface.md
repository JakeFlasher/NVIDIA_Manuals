...
title: "2. Preface"
section: "2"
source: "https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#preface"
---

# [2. Preface](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#preface)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#preface "Permalink to this headline")

This Best Practices Guide is a manual to help developers obtain the best performance from NVIDIA<sup>®</sup> CUDA<sup>®</sup> GPUs. It presents established parallelization and optimization techniques and explains coding metaphors and idioms that can greatly simplify programming for CUDA-capable GPU architectures.
...
## [2.1. Who Should Read This Guide?](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#who-should-read-this-guide)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#who-should-read-this-guide "Permalink to this headline")
...
## [2.2. Assess, Parallelize, Optimize, Deploy](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#assess-parallelize-optimize-deploy)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#assess-parallelize-optimize-deploy "Permalink to this headline")
...
![_images/apod-cycle.png](images/preface_1.png)

### [2.2.1. Assess](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#assess)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#assess "Permalink to this headline")
...
### [2.2.2. Parallelize](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#parallelize)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#parallelize "Permalink to this headline")
...
### [2.2.3. Optimize](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#optimize)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#optimize "Permalink to this headline")
...
### [2.2.4. Deploy](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#deploy)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#deploy "Permalink to this headline")
...
## [2.3. Recommendations and Best Practices](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#recommendations-and-best-practices)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#recommendations-and-best-practices "Permalink to this headline")
...
## [2.4. Assessing Your Application](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#assessing-your-application)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#assessing-your-application "Permalink to this headline")
