---
title: "19. Recommendations and Best Practices"
section: "19"
source: "https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#id98"
---

# [19. Recommendations and Best Practices](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#id98)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#id98 "Permalink to this headline")

This chapter contains a summary of the recommendations for optimization that are explained in this document.

## [19.1. Overall Performance Optimization Strategies](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#overall-performance-optimization-strategies)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#overall-performance-optimization-strategies "Permalink to this headline")
