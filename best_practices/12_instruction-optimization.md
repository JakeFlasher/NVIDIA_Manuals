---
title: "12. Instruction Optimization"
section: "12"
source: "https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#instruction-optimization"
---

# [12. Instruction Optimization](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#instruction-optimization)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#instruction-optimization "Permalink to this headline")
...
## [12.1. Arithmetic Instructions](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#arithmetic-instructions)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#arithmetic-instructions "Permalink to this headline")
...
- Minimize divergent warps caused by control flow instructions as detailed in [Control Flow Instructions](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#control-flow-instructions)
- Reduce the number of instructions, for example, by optimizing out synchronization points whenever possible as described in [Synchronization Instruction](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#synchronization-instruction) or by using restricted pointers as described in the [CUDA C++ Programming Guide](https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#restrict).
...
### [12.1.1. Throughput of Native Arithmetic Instructions](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#throughput-of-native-arithmetic-instructions)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#throughput-of-native-arithmetic-instructions "Permalink to this headline")
...
| 32-bit approximate floating-point reciprocal, reciprocal square root, base-2 logarithm, base 2 exponential, sine, cosine: `lg2.approx.f32` | 16[^5] |  |  |  |  |  |  |
...
| 32-bit integer multiply, multiply-add, extended-precision multiply-add: `mad.lo.s32` | 64[^6] |  |  |  |  |  |  |
...
| warp shuffle [^7]: `shfl.sync.idx.b32` | 16 | 32 |  |  |  |  |  |
| warp vote [^8]: `vote.sync.ballot.b32` | 64 | 128 |  |  |  |  |  |
| sum of absolute difference: `sad.s32` | 64 | 32 |  |  |  |  |  |
| 2-way SIMD absolute difference: multiple PTX instructions | Multiple instruct. |  |  |  |  |  |  |
| 4-way SIMD absolute difference: `vabsdiff4.u32.u32.u32` | 64 [^9] | 32 [^9] |  |  |  |  |  |
...
**9([1](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#id64),[2](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#id65))**
...
### [12.1.2. Control Flow Instructions](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#control-flow-instructions)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#control-flow-instructions "Permalink to this headline")
...
### [12.1.3. Synchronization Instruction](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#synchronization-instruction)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#synchronization-instruction "Permalink to this headline")
...
### [12.1.4. Division Modulo Operations](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#division-modulo-operations)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#division-modulo-operations "Permalink to this headline")
...
### [12.1.5. Loop Counters Signed vs. Unsigned](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#loop-counters-signed-vs-unsigned)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#loop-counters-signed-vs-unsigned "Permalink to this headline")
...
### [12.1.6. Reciprocal Square Root](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#reciprocal-square-root)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#reciprocal-square-root "Permalink to this headline")
...
### [12.1.7. Other Arithmetic Instructions](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#other-arithmetic-instructions)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#other-arithmetic-instructions "Permalink to this headline")
...
### [12.1.8. Exponentiation With Small Fractional Arguments](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#exponentiation-with-small-fractional-arguments)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#exponentiation-with-small-fractional-arguments "Permalink to this headline")
...
| Computation | Formula |
| --- | --- |
| x<sup>1/9</sup> | `r = rcbrt(rcbrt(x))` |
| x<sup>-1/9</sup> | `r = cbrt(rcbrt(x))` |
| x<sup>1/6</sup> | `r = rcbrt(rsqrt(x))` |
| x<sup>-1/6</sup> | `r = rcbrt(sqrt(x))` |
| x<sup>1/4</sup> | `r = rsqrt(rsqrt(x))` |
| x<sup>-1/4</sup> | `r = sqrt(rsqrt(x))` |
| x<sup>1/3</sup> | `r = cbrt(x)` |
| x<sup>-1/3</sup> | `r = rcbrt(x)` |
| x<sup>1/2</sup> | `r = sqrt(x)` |
| x<sup>-1/2</sup> | `r = rsqrt(x)` |
| x<sup>2/3</sup> | `r = cbrt(x); r = r*r` |
| x<sup>-2/3</sup> | `r = rcbrt(x); r = r*r` |
| x<sup>3/4</sup> | `r = sqrt(x); r = r*sqrt(r)` |
| x<sup>-3/4</sup> | `r = rsqrt(x); r = r*sqrt(r)` |
| x<sup>7/6</sup> | `r = x*rcbrt(rsqrt(x))` |
| x<sup>-7/6</sup> | `r = (1/x) * rcbrt(sqrt(x))` |
| x<sup>5/4</sup> | `r = x*rsqrt(rsqrt(x))` |
| x<sup>-5/4</sup> | `r = (1/x)*sqrt(rsqrt(x))` |
| x<sup>4/3</sup> | `r = x*cbrt(x)` |
| x<sup>-4/3</sup> | `r = (1/x)*rcbrt(x)` |
| x<sup>3/2</sup> | `r = x*sqrt(x)` |
| x<sup>-3/2</sup> | `r = (1/x)*rsqrt(x)` |

### [12.1.9. Math Libraries](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#math-libraries)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#math-libraries "Permalink to this headline")
...
### [12.1.10. Precision-related Compiler Flags](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#precision-related-compiler-flags)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#precision-related-compiler-flags "Permalink to this headline")
...
Another, more aggressive, option is `-use_fast_math`, which coerces every `functionName()` call to the equivalent `__functionName()` call. This makes the code run faster at the cost of diminished precision and accuracy. See [Math Libraries](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#math-libraries).

## [12.2. Memory Instructions](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#memory-instructions)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#memory-instructions "Permalink to this headline")
