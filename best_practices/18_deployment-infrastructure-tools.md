---
title: "18. Deployment Infrastructure Tools"
section: "18"
source: "https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#deployment-infrastructure-tools"
---

# [18. Deployment Infrastructure Tools](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#deployment-infrastructure-tools)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#deployment-infrastructure-tools "Permalink to this headline")

## [18.1. Nvidia-SMI](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#nvidia-smi)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#nvidia-smi "Permalink to this headline")
...
### [18.1.1. Queryable state](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#queryable-state)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#queryable-state "Permalink to this headline")
...
### [18.1.2. Modifiable state](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#modifiable-state)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#modifiable-state "Permalink to this headline")
...
## [18.2. NVML](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#nvml)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#nvml "Permalink to this headline")
...
## [18.3. Cluster Management Tools](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#cluster-management-tools)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#cluster-management-tools "Permalink to this headline")
...
## [18.4. Compiler JIT Cache Management Tools](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#compiler-jit-cache-management-tools)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#compiler-jit-cache-management-tools "Permalink to this headline")
...
## [18.5. CUDA_VISIBLE_DEVICES](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#cuda-visible-devices)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#cuda-visible-devices "Permalink to this headline")
