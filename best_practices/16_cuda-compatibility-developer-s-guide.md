---
title: "16. CUDA Compatibility Developer’s Guide"
section: "16"
source: "https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#cuda-compatibility-developer-s-guide"
---

# [16. CUDA Compatibility Developer’s Guide](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#cuda-compatibility-developer-s-guide)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#cuda-compatibility-developer-s-guide "Permalink to this headline")
...
![Components of CUDA](images/cuda-compatibility-developer-s-guide_1.png)
...
## [16.1. CUDA Toolkit Versioning](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#cuda-toolkit-versioning)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#cuda-toolkit-versioning "Permalink to this headline")
...
## [16.2. Source Compatibility](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#source-compatibility)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#source-compatibility "Permalink to this headline")
...
## [16.3. Binary Compatibility](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#binary-compatibility)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#binary-compatibility "Permalink to this headline")
...
![CUDA Toolkit and Minimum Driver Versions](images/cuda-compatibility-developer-s-guide_2.png)
...
### [16.3.1. CUDA Binary (cubin) Compatibility](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#cuda-binary-cubin-compatibility)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#cuda-binary-cubin-compatibility "Permalink to this headline")
...
## [16.4. CUDA Compatibility Across Minor Releases](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#cuda-compatibility-across-minor-releases)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#cuda-compatibility-across-minor-releases "Permalink to this headline")
...
### [16.4.1. Existing CUDA Applications within Minor Versions of CUDA](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#existing-cuda-applications-within-minor-versions-of-cuda)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#existing-cuda-applications-within-minor-versions-of-cuda "Permalink to this headline")
...
#### [16.4.1.1. Handling New CUDA Features and Driver APIs](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#handling-new-cuda-features-and-driver-apis)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#handling-new-cuda-features-and-driver-apis "Permalink to this headline")
...
#### [16.4.1.2. Using PTX](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#using-ptx)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#using-ptx "Permalink to this headline")
...
#### [16.4.1.3. Dynamic Code Generation](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#dynamic-code-generation)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#dynamic-code-generation "Permalink to this headline")
...
#### [16.4.1.4. Recommendations for building a minor-version compatible library](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#recommendations-for-building-a-minor-version-compatible-library)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#recommendations-for-building-a-minor-version-compatible-library "Permalink to this headline")
...
#### [16.4.1.5. Recommendations for taking advantage of minor version compatibility in your application](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#recommendations-for-taking-advantage-of-minor-version-compatibility-in-your-application)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#recommendations-for-taking-advantage-of-minor-version-compatibility-in-your-application "Permalink to this headline")
