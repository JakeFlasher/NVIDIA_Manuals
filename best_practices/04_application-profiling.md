---
title: "4. Application Profiling"
section: "4"
source: "https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#application-profiling"
---

# [4. Application Profiling](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#application-profiling)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#application-profiling "Permalink to this headline")

## [4.1. Profile](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#profile)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#profile "Permalink to this headline")
...
### [4.1.1. Creating the Profile](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#creating-the-profile)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#creating-the-profile "Permalink to this headline")
...
### [4.1.2. Identifying Hotspots](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#identifying-hotspots)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#identifying-hotspots "Permalink to this headline")

In the example above, we can clearly see that the function `genTimeStep()` takes one-third of the total running time of the application. This should be our first candidate function for parallelization. [Understanding Scaling](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#understanding-scaling) discusses the potential benefit we might expect from such parallelization.
...
### [4.1.3. Understanding Scaling](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#understanding-scaling)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#understanding-scaling "Permalink to this headline")
...
#### [4.1.3.2. Weak Scaling and Gustafson’s Law](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#weak-scaling-and-gustafson-s-law)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#weak-scaling-and-gustafson-s-law "Permalink to this headline")
...
#### [4.1.3.3. Applying Strong and Weak Scaling](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide#applying-strong-and-weak-scaling)[](https://docs.nvidia.com/cuda/cuda-c-best-practices-guide/#applying-strong-and-weak-scaling "Permalink to this headline")
