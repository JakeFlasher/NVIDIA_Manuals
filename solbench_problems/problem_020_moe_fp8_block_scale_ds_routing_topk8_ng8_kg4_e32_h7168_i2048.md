...
| Name | Shape | Dtype |
| --- | --- | --- |
| routing_logits | [seq_len, num_experts] | float32 |
| routing_bias | [num_experts] | bfloat16 |
| hidden_states | [seq_len, hidden_size] | float8_e4m3fn |
| hidden_states_scale | [num_hidden_blocks, seq_len] | float32 |
| gemm1_weights | [num_local_experts, gemm1_out_size, hidden_size] | float8_e4m3fn |
| gemm1_weights_scale | [num_local_experts, num_gemm1_out_blocks, num_hidden_blocks] | float32 |
| gemm2_weights | [num_local_experts, hidden_size, intermediate_size] | float8_e4m3fn |
| gemm2_weights_scale | [num_local_experts, num_hidden_blocks, num_intermediate_blocks] | float32 |
...
| # | num_experts | num_local_experts | hidden_size | intermediate_size | gemm1_out_size | num_hidden_blocks | num_intermediate_blocks | num_gemm1_out_blocks | seq_len | Baseline (ms) | SOL (ms) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 7 | 1.5544 | 0.3681 |
| 2 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 1 | 1.0270 | 0.3680 |
| 3 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 32 | 5.5979 | 0.3682 |
| 4 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 80 | 6.5550 | 0.3683 |
| 5 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 901 | 12.1428 | 1.4025 |
| 6 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 16 | 2.6855 | 0.3681 |
| 7 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 15 | 1.5388 | 0.3681 |
| 8 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 14 | 2.3606 | 0.3681 |
| 9 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 14107 | 44.4253 | 21.9529 |
| 10 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 11948 | 31.6765 | 18.5932 |
| 11 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 62 | 3.9067 | 0.3683 |
| 12 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 59 | 3.7386 | 0.3683 |
| 13 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 58 | 5.7869 | 0.3683 |
| 14 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 57 | 5.2373 | 0.3683 |
| 15 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 56 | 5.1636 | 0.3682 |
| 16 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 55 | 4.8304 | 0.3682 |
| 17 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 54 | 4.4948 | 0.3682 |
| 18 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 53 | 4.8820 | 0.3682 |
| 19 | 256 | 32 | 7168 | 2048 | 4096 | 56 | 16 | 32 | 52 | 3.3441 | 0.3682 |
...
| --- | --- | --- | --- |
| - | SOL Bound | 1.000000 | 0.602192 ms |
| - | Scoring Baseline | 0.500000 | 4.773667 ms |
| - | Reference Implementation | 0.208534 | 17.634960 ms |
