---
title: "Predication: What to do when tiling isn’t perfect"
section: ""
source: "https://docs.nvidia.com/cutlass/latest/media/docs/cpp/cute/0y_predication.html#predication-what-to-do-when-tiling-isn-t-perfect"
---

# [Predication: What to do when tiling isn’t perfect](https://docs.nvidia.com/cutlass/latest/media/docs/cpp/cute#predication-what-to-do-when-tiling-isn-t-perfect)[](https://docs.nvidia.com/cutlass/latest/media/docs/cpp/cute/#predication-what-to-do-when-tiling-isn-t-perfect "Permalink to this headline")

The [GEMM tutorial](https://docs.nvidia.com/cutlass/latest/media/docs/cpp/cute/0x_gemm_tutorial.html) shows how
