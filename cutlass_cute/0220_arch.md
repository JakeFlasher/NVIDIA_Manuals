...
title: "arch"
section: ""
source: "https://docs.nvidia.com/cutlass/latest/media/docs/pythonDSL/cute_dsl_api/cute_arch.html#arch"
---

# [arch](https://docs.nvidia.com/cutlass/latest/media/docs/pythonDSL/cute_dsl_api#arch)[](https://docs.nvidia.com/cutlass/latest/media/docs/pythonDSL/cute_dsl_api/#arch "Permalink to this headline")
