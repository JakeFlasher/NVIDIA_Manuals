---
title: "4. Instruction Set Reference"
section: "4"
source: "https://docs.nvidia.com/cuda/cuda-binary-utilities/#instruction-set-reference"
---

# [4. Instruction Set Reference](https://docs.nvidia.com/cuda/cuda-binary-utilities#instruction-set-reference)[](https://docs.nvidia.com/cuda/cuda-binary-utilities/#instruction-set-reference "Permalink to this headline")

This section contains instruction set reference for NVIDIA<sup>®</sup> GPU architectures.

## [4.1. Turing Instruction Set](https://docs.nvidia.com/cuda/cuda-binary-utilities#turing-instruction-set)[](https://docs.nvidia.com/cuda/cuda-binary-utilities/#turing-instruction-set "Permalink to this headline")
...
[Table 6](https://docs.nvidia.com/cuda/cuda-binary-utilities/#turing-turing-instruction-set-table) lists valid instructions for the Turing GPUs.
...
## [4.2. NVIDIA Ampere GPU and Ada Instruction Set](https://docs.nvidia.com/cuda/cuda-binary-utilities#nvidia-ampere-gpu-and-ada-instruction-set)[](https://docs.nvidia.com/cuda/cuda-binary-utilities/#nvidia-ampere-gpu-and-ada-instruction-set "Permalink to this headline")
...
[Table 7](https://docs.nvidia.com/cuda/cuda-binary-utilities/#ampere-ampere-instruction-set-table) lists valid instructions for the NVIDIA Ampere architecrture and Ada GPUs.
...
## [4.3. Hopper Instruction Set](https://docs.nvidia.com/cuda/cuda-binary-utilities#hopper-instruction-set)[](https://docs.nvidia.com/cuda/cuda-binary-utilities/#hopper-instruction-set "Permalink to this headline")
...
[Table 8](https://docs.nvidia.com/cuda/cuda-binary-utilities/#hopper-hopper-instruction-set-table) lists valid instructions for the Hopper GPUs.
...
## [4.4. Blackwell Instruction Set](https://docs.nvidia.com/cuda/cuda-binary-utilities#blackwell-instruction-set)[](https://docs.nvidia.com/cuda/cuda-binary-utilities/#blackwell-instruction-set "Permalink to this headline")
